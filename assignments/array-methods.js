...
//     fullName = runners.map(function(arrayItem){
//         return (`${arrayItem.first_name} ${arrayItem.last_name}`)
//     });
...
let fullName = [];
    ...
    fullName = runners.forEach(function(arrayItem){
        return (console.log(arrayItem.first_name,arrayItem.last_name))
    });
...
let allCaps = [];
    ...
    allCaps = runners.map(function(arrayItem){
        return (`${arrayItem.first_name.toUpperCase()}`)
    })
...
let largeShirts = [];
    ...
    largeShirts = runners.filter(function(firstName){
        return firstName.shirt_size === "L";
    })
